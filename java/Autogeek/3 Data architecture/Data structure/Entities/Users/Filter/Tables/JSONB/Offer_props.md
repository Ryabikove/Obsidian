...
| --------------- | --------- | -------- | ------- | ------------------------------------------------------------------------------------------------------------------------ |
| owners_quant    | bytea     | -        | -       | Owners quantity                                                                                                          |
| is_vrc_original | boolean   | -        | -       | VRC original                                                                                                             |
| offer_type_ids  | bytea     | -        | -       | Offer type ids from [[Autogeek/3 Data architecture/Data structure/Entities/Users/Offer/Tables/Offer_types\|offer_types]] |
