Table which contains information about [[Autogeek/4 UX-projecting/Data structure/Entities/Users/Account/Account|accounts]].
...
| country_code   | Varchar(3)                 | FK many to one | +        | -       | Iso_code from [[Autogeek/4 UX-projecting/Data structure/Entities/General/Country/Tables/Countries\|countries]] |
| city_id        | Int                        | FK many to one | -        | -       | Id from [[Autogeek/4 UX-projecting/Data structure/Entities/General/City/Tables/Cities\|cities]]                |
