...
| city_id           | Int                        | FK one to many | +        | -       | City id from [[Autogeek/4 UX-projecting/Entities/General/City/Tables/Cities\|cities]]                             |
...
| offer_type_id     | Bytea                      | FK one to many | +        | -       | Type of offer from table [[Autogeek/4 UX-projecting/Entities/Users/Offer/Tables/Offer_types\|offer_types]]        |
| price             | Big int                    | -              | +        | -       | Price                                                                                                             |
...
| body_color_type   | Bytea                      | FK one to many | +        | -       | Color type from table [[Autogeek/4 UX-projecting/Entities/Users/Offer/Tables/Body_color_types\|body_color_types]] |
