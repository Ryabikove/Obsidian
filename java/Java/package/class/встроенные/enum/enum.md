...
==особенности==:
 ...
 - по умолчанию конструктор внутри перечисления приватный ([[Java/package/class/модификаторы/private|private]])
...
==требования==:
 - единственный разрешенный модификатор приватности конструктора - [[Java/package/class/модификаторы/private|private]], использование других вызовет ошибку
