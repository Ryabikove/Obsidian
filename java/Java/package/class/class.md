...
в состав класса входят:
 ...
 - [[Java/package/class/Field|атрибуты]]
...
==требования==:
 - главный класс любой программы на java ==должен== содержать метод [[Java/package/class/метод/main|main]]
...
==особенности==:
 ...
 - помимо базовых классов есть абстрактные классы [[Java/variables/modifiers/abstract|abstract]]
