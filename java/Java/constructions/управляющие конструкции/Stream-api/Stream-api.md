...
- Потоки могут быть последовательными или [[Java/constructions/управляющие конструкции/Stream-api/Параллелизация|параллельными]]
...
- Параллелизация - возможность переключения на [[Java/constructions/управляющие конструкции/Stream-api/Параллелизация|параллельную]] обработку;
