В java можно определять класс внутри другого, тем самым создавая [[Java/package/class/внутренние классы|внутренние классы]]. Это полезно, когда один класс нужен только внутри другого и нигде больше.
...
```
Именно из анонимных классов выросли [[Java/constructions/управляющие конструкции/Лямбда-выражения|Лямбда-выражения]]. В современном коде вместо 5 строк анонимного класса пишут одну: 
